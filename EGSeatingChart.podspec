#
#  Be sure to run `pod spec lint SmartUITableView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Anton Kovalchuk" => "antonk@entechsolutions.com",
  ...
  s.source       = { :git => "https://github.com/entechsolutions/EGSeatingCharts.git", :tag => "0.6" }
  ...
  # s.resource  = "icon.png"
  s.resources = "EGSeatingChartsExample/Resources/*.{xib,png,plist}"
